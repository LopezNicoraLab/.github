...
The Lopez-Nicora Lab advances soybean disease and nematode management through integrative field research, population biology, epidemiology, and reproducible data science.

Our work bridges discovery, Extension, and applied impact for growers across the United States and internationally. We focus on developing science-based solutions that improve soybean productivity, sustainability, and resilience.
...
- Analytical workflows supporting peer-reviewed publications  
- Code associated with field trials and greenhouse assays  
- Statistical and epidemiological modeling scripts  
- Extension decision-support tools  
- Graduate training materials and tutorials  

We are committed to transparency, reproducibility, and open science.
...
Code repositories associated with manuscripts are linked directly within each publication and include version-controlled scripts, metadata documentation, and citation information.

When available, repositories are archived with DOI identifiers through Zenodo for long-term accessibility.
...
Soybean Pathologist and Nematologist  
Department of Plant Pathology  
The Ohio State University  

For collaboration inquiries, please contact via institutional email.

---

## Funding & Partnerships

Our research program is supported by competitive grants, commodity boards, and multi-state collaborations committed to advancing soybean health and productivity.
